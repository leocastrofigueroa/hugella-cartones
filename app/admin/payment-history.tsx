        ...
        <section className="my-auto w-full max-w-lg rounded-[var(--hugella-radius-card)] bg-white p-5 shadow-2xl sm:p-7">
          ...
          <form onSubmit={submitCorrection} className="mt-5">
            <fieldset disabled={submitting || disabled} className="space-y-4 disabled:opacity-60">
              ...
              <div><label className="field-label" htmlFor="correction-method">Medio de pago</label><input id="correction-method" name="method" className="field-control" defaultValue={correctionPayment.medio_pago} list="correction-methods" required /><datalist id="correction-methods"><option value="Transferencia" /><option value="Efectivo" /><option value="Tarjeta de débito" /><option value="Mercado Pago" /></datalist></div>
